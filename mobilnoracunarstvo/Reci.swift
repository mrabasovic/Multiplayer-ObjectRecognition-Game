...
struct Reci{
    ...
    var words = ["computer keyboard", "orange", "water bottle", "pomegranate", "analog clock", "backpack", "computer mouse", "calendar", "mug", "scissors", "spoon", "lamp", "chocolate", "flower", "helmet", "wallet", "truck", "soap", "perfume", "sticky note", "camera", "bread", "tweezers", "towel", "hanger", "bed", "stop sign", "nail clippers", "toilet", "flag", "toothbrush", "apple", "banana", "watch", "watermelon", "plate", "glasses", "key", "television", "deodorant", "shovel", "broccoli",  "piano", "door"]
